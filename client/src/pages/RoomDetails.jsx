...
const RoomDetails = () => {
  ...
  return room && (
    ...
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
      ...
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-yellow-200 shadow-[0px_0px_20px_rgba(0,0,0,0.15)] 
      p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
          ...
          <div className='flex flex-col'>
            ...
            <input type='date' id='checkInDate' placeholder='Check-In' className='w-full rounded border-gray-300 px-3 py-2 mt-1 outline-none' required />
          </div>

          <div className='w-px h-15 bg-black max-md:hidden'></div>


          <div className='flex flex-col'>
            <label htmlFor='checkOutDate' className='font-bold'>Check-Out</label>

            <input type='date' id='checkOutDate' placeholder='Check-Out' className='w-full rounded border-gray-300
            px-3 py-2 mt-1 outline-none' required />
          </div>
      ...
      <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
        <p>Guests will be allocated on the ground floor according to availability. You get a comfortable
          Two bedroom apartment has a true city feeling. The price quoted is for two guests, at the guests
          slot please mark the number of guests to get the exact price for groups. The guests will be 
          allocated ground floor according to availability. You get a comfortable two bedroom apartment has a true city feeling.
        </p>
      </div>
      ...
      <div className='flex flex-col items-start gap-4'>
        ...
        <button className='px-6 py-2.5 mt-4 rounded text-white bg-primary hover:bg-blue-500
